...
-- ----------------------------
-- Table structure for deleteimages
-- ----------------------------
--DROP TABLE IF EXISTS `deleteimages`;
CREATE TABLE `deleteimages`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `ImagePath` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `ReqDeleteTime` datetime(0) NOT NULL,
  `UserId` int(11) NOT NULL,
  `IsDeleted` tinyint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '存储要删除的图片信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `image_delete_record`  (
  ...
  `IsDeleted` tinyint(1) NULL DEFAULT 0 COMMENT '是否已删除，默认为false',
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for imagestodelete
-- ----------------------------
DROP TABLE IF EXISTS `imagestodelete`;
CREATE TABLE `imagestodelete`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `ImagePath` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `ReqDeleteTime` datetime(0) NOT NULL,
  `UserId` int(11) NOT NULL,
