...
INSERT INTO `msgconfiguration` VALUES (1, '欢迎来到同校表白墙， 请大家文件发言，您的投稿就是我坚持不懈的动力', 1);
...
CREATE TABLE `school`  (
  ...
  `NumberLuckyDraws` int(4) NULL DEFAULT 0 COMMENT '可抽奖次数，设置0表示没有开启，和策略也有关系',
  PRIMARY KEY (`Id`) USING BTREE
