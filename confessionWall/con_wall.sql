...
INSERT INTO `user` VALUES (1, '', 1, 'owFJn5JydzwLQx52JN9p7CtpzHFo',
...
INSERT INTO ConfessionWall (SchoolId, CreatorUserId, AvatarURL, WallName, Description, Status)
VALUES (1, 1, 'https://example.com/avatar1.jpg', '表白墙A', '这是表白墙A的描述', 0),
       (2, 2, 'https://example.com/avatar2.jpg', '表白墙B', '这是表白墙B的描述', 1);
...
CREATE TABLE ConfessionPost (
                                ...
                                PublishTime TIMESTAMP COMMENT '实际发布时间',
