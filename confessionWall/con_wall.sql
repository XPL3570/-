...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 1, 1, 1, '1111111', 'zj', 'BSVnOEW10hOMPNDKnbDT8Q==', 0, '2023-09-02 09:40:19', 1);
INSERT INTO `admin` VALUES (2, 2, 2, 2, '9876543210', 'adminwx2', 'BSVnOEW10hOMPNDKnbDT8Q==', 0, '2023-09-02 09:40:19', 0);
...
INSERT INTO `confessionpost` VALUES (674, 1, 1, '你好是这样的', '你说我要怎么样你才满意啊', 'http://127.0.0.1:2204/upload/20230908175421eLdKnH.png;http://127.0.0.1:2204/upload/20230908175425mWygZo.png', '2023-09-08 17:54:49', NULL, 0, 1, 0, 0);
...
CREATE TABLE `school`  (
                           ...
                           `IsVerified` tinyint(4) NULL DEFAULT 0 COMMENT '审核状态，0表示未通过，1表示通过',
                           `IsDeleted` tinyint(1) NULL DEFAULT 0 COMMENT '逻辑删除标志',
                           PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- Records of school
-- ----------------------------
INSERT INTO `school` VALUES (1, '学校A', 'https://example.com/avatar1.jpg', '这是学校A的描述', 1, '2023-08-30 16:22:28', NULL, NULL, 0, 0);
INSERT INTO `school` VALUES (2, '学校B', 'https://example.com/avatar2.jpg', '这是学校B的描述', 2, '2023-08-30 16:22:28', NULL, NULL, 0, 0);
